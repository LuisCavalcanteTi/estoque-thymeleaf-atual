...
import br.com.estoqueartesanart.mvc.estoqueartesanart.tdo.ComprasTdo;
...
public class UsuarioRequisitaPedidosController {
	...
	@PostMapping("/requisitarPedido/compras")
	public String formCompras(ComprasTdo comprasTdo) {
	...
	String username = SecurityContextHolder.getContext().getAuthentication().getName();
		...
		Compras compras = comprasTdo.formCompras();
		compras.setUsername(user.getUsername());
